...
Depending on the API, create a new user will request different informations as the name and the password. However, the API will generate a token for every user.
...
Store in a variable `records.df` the result of the fonction `get_from_agromet_API.fun(user_token.chr, table_name.chr, sensors.chr=NULL, stations_ids.chr, dfrom.chr, dto.chr)` où :
